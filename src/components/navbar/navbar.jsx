...
import Img from '../../assets/logo-webreinvent.svg'
import {
  Square3Stack3DIcon,
  ChevronDownIcon,
    ...
    <ul className="mb-4 mt-2 flex flex-col gap-[1rem] lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-[1rem] text-[white] ">
      ...
      <Menu  allowHover open={isMenuOpen} handler={setIsMenuOpen}>
        ...
        <MenuList className=" bg-[white] text-[#00000] border-none cursor-pointer shadow">
            <Typography variant="small" color="gray" className="font-normal text-sm p-2">
              Product Engineering
            </Typography>
            <Typography variant="small" color="gray" className="font-normal text-sm p-2">
        ...
        <MenuHandler>
          <Typography as="a" href="#" variant="small" className="font-normal">
            <MenuItem className="hidden items-center gap-2 text-blue-gray-900 lg:flex lg:rounded-full">
              ...
              <ChevronDownIcon
                strokeWidth={2}
                className={`h-3 w-3 transition-transform ${isMenuOpen1 ? "rotate-180" : ""
                  }`}
              />
            </MenuItem>
          </Typography>
        ...
        <MenuHandler>
          <Typography as="a" href="#" variant="small" className="font-normal">
            <MenuItem className="hidden items-center gap-2 text-blue-gray-900 lg:flex lg:rounded-full">
              ...
              <ChevronDownIcon
                strokeWidth={2}
                className={`h-3 w-3 transition-transform ${isMenuOpen2 ? "rotate-180" : ""
                  }`}
              />
            </MenuItem>
          </Typography>
        ...
        <MenuHandler>
          <Typography as="a" href="#" variant="small" className="font-normal">
            <MenuItem className="hidden items-center gap-2 text-blue-gray-900 lg:flex lg:rounded-full">
              ...
              <ChevronDownIcon
                strokeWidth={2}
                className={`h-3 w-3 transition-transform ${isMenuOpen3 ? "rotate-180" : ""
                  }`}
              />
            </MenuItem>
          </Typography>
        ...
        <MenuHandler>
          <Typography as="a" href="#" variant="small" className="font-normal">
            <MenuItem className="hidden items-center gap-2 text-blue-gray-900 lg:flex lg:rounded-full">
              ...
              <ChevronDownIcon
                strokeWidth={2}
                className={`h-3 w-3 transition-transform ${isMenuOpen4 ? "rotate-180" : ""
                  }`}
              />
            </MenuItem>
          </Typography>
        ...
        <MenuHandler>
          <Typography as="a" href="#" variant="small" className="font-normal">
            <MenuItem className="hidden items-center gap-2 text-blue-gray-900 lg:flex lg:rounded-full">
              ...
              <ChevronDownIcon
                strokeWidth={2}
                className={`h-3 w-3 transition-transform ${isMenuOpen5 ? "rotate-180" : ""
                  }`}
              />
            </MenuItem>
          </Typography>
